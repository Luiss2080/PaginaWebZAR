...
- [ ] **T1 — Reparar estructura e imports** (RF: criterio de finalización)
...
- [ ] **T2 — Tokens y estilos globales Zara** (RF-1)
...
- [ ] **T3 — Capa de datos** (RF-35, RF-36, RF-37)
...
- [ ] **T4 — Contextos globales** (RF-21, RF-29)
...
- [ ] **T5 — Layout editorial** (RF-2, RF-3, RF-4, RF-5)
...
- [ ] **T7 — Catálogo** (RF-7, RF-8, RF-9, RF-10, RF-11)
...
- [ ] **T8 — Detalle de producto** (RF-12, RF-13, RF-14, RF-15, RF-16)
...
- [ ] **T9 — Drawer de carrito** (RF-17, RF-18, RF-19, RF-20, RF-22)
...
- [ ] **T10 — Panel de búsqueda** (RF-23, RF-24, RF-25, RF-26)
...
- [ ] **T11 — Favoritos** (RF-27, RF-28, RF-30)
...
- [ ] **T12 — Cuenta** (RF-31, RF-32, RF-33, RF-34)
...
- [ ] **T13 — 404, estáticas y newsletter** (RF-38, RF-39, RF-40)
...
- [ ] **T15 — Pulido final** (RF-1, RF-41, NFRs)
