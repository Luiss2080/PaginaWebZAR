...
- [x] **T17 — Migración del esquema** (RF-42..RF-47)
...
- [x] **T18 — API catálogo dinámico** (RF-42..RF-47)
...
- [x] **T19 — SPA en modo BD (catálogo)** (RF-42..RF-47)
...
- [x] **T23 — Frontend dinámico** (RF-48..RF-53)
